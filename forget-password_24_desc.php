...
switch($action)
{
    ...
    default:
        ...
        $content = 'If the person has entered a wrong number. <br>
...
<div class="clear step-wrap">
    <aside class="boxsize">
        ...
        <div id="<?php echo $inputId; ?>">
            <?php echo $select; ?>
<!--            <div id="userIderr"></div>
            
            <input type="hidden" name="smsCall" id="smsCall">-->
            
<button  type="button" name="smsSubmit" id="smsSubmit" style="margin-right:10px;" href="#" class="button large googleplus " onclick="validate('sms')" smsorcall="sms">
                Reset via Call
            </button>
            <button type="button" name="callSubmit" id="callSubmit" href="#" class="button large facebook " onclick="validate('call')" smsorcall="call">
                Reset via SMS
            </button>
