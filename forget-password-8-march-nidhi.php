...
<form name="forgotPassword" class="forgotPassword" id="forgotPassword" method="post" action="https://phone.phone91.com/controller/forgotPasswordApi.php" onSubmit="return validate('userId' , 'forgotPassword');" > 
...
<div style="padding:40px 0 20px" class="wrapper clear">
	<h2>The following numbers are associated with the username <span class="themeClr"><?php echo $responseArr['userName']; ?></span></h2>
</div>    

    <form name="selectNumber" class="selectNumber" id="selectNumber" method="post" action="https://phone.phone91.com/controller/forgotPasswordApi.php" onSubmit="return validate('userId' , 'selectNumber');" >  
    <div class="clear step-wrap">
    	<aside class="boxsize">
        	<div class="pdR3">
                ...
                <div id="selwrp">
                    ...
                    <input type="hidden" name="smsCall" id="smsCall" value="SMS"/>
                     ...
                     <button type="submit"  href="#" class="btn btn-danger btn-mid  btnapp  googleplus"> 
                            SMS ME
                    </button> 
...
<form name="verifyNumber" class="verifyNumber" id="verifyNumber" method="post" action="http://phone91.com/action.php?action=verifyConfirmation" > 
...
<aside class="boxsize">
    <div class="pdR3">
        <div class="verifyform">
            ...
            <button type="submit" class="btdn">Done</button>
         ...
         <?php if($type == 'EMAIL') 
            { ?>
                ...
                <p class="para16 mdf">
                    ...
                    request another one via <a href="https://phone.phone91.com/controller/forgotPasswordApi.php?smsCall=MAIL&userId=<?php echo $confirmMobileNumber; ?>">Email</a>
                </p>
        ...
        <p class="para16 mdf">
            If you didn't receive the code yet, <br>
            request another one via <a href="https://phone.phone91.com/controller/forgotPasswordApi.php?smsCall=SMS&userId=<?php echo $number; ?>&countryCode=<?php echo $countryCode; ?>">SMS</a> or <a href="https://phone.phone91.com/controller/forgotPasswordApi.php?smsCall=CALL&userId=<?php echo $number; ?>&countryCode=<?php echo $countryCode; ?>">call</a>
        </p>
...
<div class="error_red"><?php if(isset($requestParam['msg']) && !empty($requestParam['msg'])) {  echo $requestParam['msg']; } ?></div>
 <div id="userIderr"></div>   
<form name="resetPassword" id="resetPassword" method="post" action="http://phone91.com/action.php?action=resetPasword" onSubmit="return validate('new_pwd' , 'resetPassword');" >
<div class="clear step-wrap" style="">
    <aside class="boxsize">
        <div class="pdR3">
            <div class="lgBg">
