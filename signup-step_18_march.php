        ...
        <div class="secStep allstep " style="<?php echo (isset($_REQUEST['error']))? '' :'display:none'; ?>">
      	 <div>
            ...
            <div class="clear step-wrap" style="">
                <aside class="boxsize">
                    <div class="pdR3">
                         <form name="verify" class="" id="verificationform" onSubmit="return confirmMobileNumber();" method="post" action="https://voice.phone91.com/controller/signUpController.php?call=verifyNumber">
        ...
        <!--Third step start from here -->
         <div class="thirdStep allstep " style="display:none;">
            ...
            <div style="padding:40px 0 20px" class="wrapper clear">
                ...
                <form name="fbCurrencyForm" id="fbCurrencyForm" method="POST" action="https://voice.phone91.com/controller/signUpController.php?call=facebookGoogleSignup" > 
            <div class="clear step-wrap" style="">
            <aside class="boxsize">
                <div class="pdR3">
                    <div class="verifyform">
...
$.ajax({type: "GET",url: "https://voice.phone91.com/controller/signUpController.php",data:{"call":"verifyContactNumber","mobileNumber":mobileNumber,"countryCode":code,"carrierType":carierType},dataType: 'jsonp',
	    success: function(response)
	    { 
		    if(response.status=="success")
                    {
...
$.ajax({type: "GET",url: "https://voice.phone91.com/controller/signUpController.php",data:{"call":"resendVerifyCode","smscall":smscall},dataType: 'jsonp',
	    success: function(response)
	    { 
		      $('#resendResponse').html(response.msg);
                      if(response.status == "success"){
                          if(smscall == 'sms'){
                            setTimeout(function(){ $('#ReSms').attr('onClick','resendCode("sms")') },10000);
                          }else
                            setTimeout(function(){ $('#ReCall').attr('onClick','resendCode("call")') },10000);
                      }else
                      {
...
function backAddNumber(){
    $.ajax({type: "GET",url: "https://voice.phone91.com/controller/signUpController.php",data:{"call":"backAddNumber"},dataType: 'jsonp',
	    success: function(response)
	    { 
		     $('.allstep').hide();
                     $('.firstStep').show();  
...
setInterval(function(){ window.location = 'https://voice.phone91.com/userhome.php#!contact.php'; },3000);
}
</script>
</body>
</html>