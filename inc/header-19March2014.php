...
<header id="header">
    <div class="wrapper clear">
        <h1><a href="/index.php"><img src="/images/logo.png" alt="Phone91" title="Phone91" border="0" /></a></h1>
        <nav>
        	<ul class="clear">
                <h4></h4>   
               ...
               <li  class="link"><a <?php if(end($arr)=='two-way-calling-api.php') {echo'class="active"';}?> href="/two-way-calling-api.php">Two-way calling</a></li> 
               <li  class="link"><a <?php if(end($arr)=='reseller-api.php') {echo'class="active"';}?> href="/reseller-api.php">Reseller</a></li>
