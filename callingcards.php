...
<link rel="stylesheet" type="text/css" href="css/callingcards-style.css" />
</head>
<body >
<?php include_once('inc/header.php') ?>
<section id="cc-banner" class="warmBg">
	<div class="wrapper clear">
        <section class="top-part alC">
        	<h2 class="">Your quickest way to recharge is here</h2>            
        </section>
...
<section id="cc-container" class="hgPart">
	<div class="h3g">How to <span class="themeClr">use</span> calling cards?</div>
	<div class="wrapper">
        <section class="res-feat-row clear">
            <aside class="col-3">
                <div class="pdR3">
                    ...
                    <p class="para16">Get Phone91's calling card from a nearest place to start international calling. If you wish to be a reseller via calling cards, let us know.</p>
                </div><!--/end of pd div-->
            </aside><!--/end of aside-->
