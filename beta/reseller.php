...
<meta name="description" content="Try hands on reseller business to boost your revenue. Start online voice calling reseller program with our white label solutions or internet  call shop option." /> 
<meta name="keywords" content="call shop, callshop, call shop business, internet call shop, online calling card reseller" />
<title>White Label Reseller Solution via Online Calling Cards & Call Shop</title>
<?php include_once('inc/head.php') ?>
<link rel="stylesheet" type="text/css" href="<?php echo $cssUrl?>reseller-style.css" />
</head>
<body class="reseller">
        ...
        <section id="res-illus">
            <div id="inner">
                    <aside class="cc-wrap boxsize"><a href="#calling-card">
                        ...
                        <figure><img src="<?php echo $imgUrl?>screen-shot-calling-card.png" /></figure>
                    </a></aside>
                    <aside class="wl-wrap boxsize"><a href="#white-label">
                        <figcaption>White Label</figcaption>
                        <figure><img src="<?php echo $imgUrl?>whitelabel.png" /></figure>
                    </a></aside>
            </div>
        </section>
    </div>
        ...
        <section class="res-feat-row clear">
            <aside class="col-2">
                <div class="pdR3">
                    ...
                    <p class="para16">
                    As a Phone 91 reseller, you can buy calling cards in bulk at a<a href="http://phone91.com/pricing.php"> discounted price</a> and sell it further to the people you want. 
                    Once done purchasing, you can add PINs in your account by giving them a batch name and assign
                    different tariff to different batches as well. </p>
                </div><!--/end of pd div-->
            </aside><!--/end of aside-->
        ...
        <section class="res-feat-row clear">
        	<aside class="col-2">
                <div class="pdR3">
                    ...
                    <p class="para16"> 
                        Give your clients the ease to connect with their dear ones on the go with white label dialer for <a href="http://phone91.com/downloads.php#iphone">Iphone</a>, <a href="http://phone91.com/downloads.php#android">Android</a> and other mobiles. Phone 91 will customize the dialer as per your requirements and you can make it available to your clients so that they can make calls with it. </p>
                </div><!--/end of pd div-->
            </aside><!--/end of aside-->
...
function showResponse(response, statusText, xhr, $form){
	...
	$('#mes').delay(400).fadeIn(3000);  
         $(':input','#reseller-query')
           ...
           $.ajax({
                    url:"resellerGoogleCheckout.php",
                    type:"post",
                    dataType:"html",
