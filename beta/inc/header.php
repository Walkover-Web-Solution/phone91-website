...
<header id="header">
    <div class="wrapper clear">
        <h1><a href="/beta/index.php"><img src="<?php echo $imgUrl?>logo.png" alt="Phone91" title="Phone91" border="0" /></a></h1>
        <nav>
        	<ul class="clear">
                <h4></h4>   
               ...
               <li  class="link"><a <?php if(end($arr)=='two-way-calling-api.php') {echo'class="active"';}?> href="/beta/two-way-calling-api.php">Two-way calling</a></li>               <li  class="link"><a <?php if(end($arr)=='reseller-api.php') {echo'class="active"';}?> href="/beta/reseller-api.php">Reseller</a></li>
               <li  class="link"><a <?php if(end($arr)=='basic.php') {echo'class="active"';}?> href="/beta/basic.php">Basic</a></li>
                ...
                <?php }else {  ?>
                <li class="signup"><a <?php if(end($arr)=='signup.php') {echo'class="active"';}?> href="/beta/signup.php">Sign up</a></li>
                ...
                <!--<li  class="link"><a href="javasript:void(0);">Add-ons</a>
               		<ul class="subnav">
                        <li><a href="/beta/callingcards.php">Calling Cards</a></li>
                    </ul>
               	</li>-->
                <li class="link"><a <?php if(end($arr)=='reseller.php') {echo'class="active"';}?> href="/beta/reseller.php">Reseller</a></li>
                ...
                <li class="link"><a <?php if(end($arr)=='downloads.php') {echo'class="active"';}?> href="/beta/downloads.php#iphone">Download apps</a>
                	<ul class="subnav">
                        <li><a href="/beta/downloads.php#iphone">iPhone</a></li>
                        <li><a href="/beta/downloads.php#android">Android</a></li>
                    </ul>
                </li>
...
<ul class="ln clear" id="mobile-nav">
    ...
    <li><a href="/beta/downloads.php">Download apps</a></li>    
