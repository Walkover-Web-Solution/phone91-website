...
class functions 
{
    ...
    function verifyConfirmation($param)
    {
        ...
        if(isset($param['type']) && $param['type'] == 'EMAIL')
        {
           ...
           $connectUrl = 'https://voip91.com/action_layer.php?action=verifyConfirmation&number='.$param['number'].'&code='.$param['code'].'&type=EMAIL'; // Do not change
        }
        else
        {
            #- server url to send confirmation code and mobile number.
    ...
    function resetPasword($param)
    {
        ...
        if(isset( $_SESSION['type']) &&  $_SESSION['type'] == 'EMAIL')
        {
            ...
            $connectUrl = 'https://voip91.com/action_layer.php?action=reset_pwd&code='.$_SESSION['code'].'&mobNum='.$_SESSION['number'].'&key='.$_SESSION['key'].'&new_pwd='.$param['new_pwd'].'&type=EMAIL'; // Do not change
        }
        else
        {
            #- Server Url To Send Password. 
    ...
    function addFeedBackAndRequirements($parm)
    {
       ...
       $response = $this->sendMail($messageResponse , $reqParam['emailId'] ,$subject );
        ...
        $this->sendMail($table , "support@phone91.com" , 'verify user email');
    ...
    function adminTemplate()
    {
        ...
        $mailData = <<<EOF
            ...
            <div>In the meantime, find out what's new on Phone91 at <a href="#"  style="color:#296FA2;  text-decoration:none">Facebook</a>, <a href="#"  style="color:#296FA2;  text-decoration:none">Twitter</a> and our blog - <a href="#"  style="color:#296FA2;  text-decoration:none">Phone 91</a>. You never know when you find something interesting. May be a running offer.</div>
...
EOF;
    ...
    function contactTemplate()
    {
        ...
        <div>
        In the meantime, find out what's new on   <a href="#"  style="color:#296FA2;  text-decoration:none">Facebook</a>, <a href="#"  style="color:#296FA2;  text-decoration:none">Twitter</a> and our blog - <a href="#"  style="color:#296FA2;  text-decoration:none">Phone 91</a>. You never know when you find something interesting. May be a running offer. 
        </div>
