...
<!--                            <a class="button large googleplus db fl" href="<?php echo REDIRECT_FB_GOOGLE; ?>login/login-google.php?userDomain=<?php echo $_SERVER['HTTP_HOST']?>"><i class="ss-icon ss-social"></i> Sign up with Google</a> -->
                            <a class="button large facebook db" href="<?php echo REDIRECT_FB_GOOGLE; ?>login/login-fb.php?userDomain=<?php echo $_SERVER['HTTP_HOST']?>"><i class="ss-icon ss-social"></i> Sign up with Facebook</a>
					</div>
                </div>
                ...
                <div id="opt2">
                    <form name="signup" class="signup" id="signup" onSubmit="return validate();" method="post" action="<?php echo REDIRECT_VOIP; ?>/action_layer.php?action=signupP91">
...
<!--                                <input type="submit" id="signupSubmit" title="Submit" value="Submit" onfocus="this.blur();"/>-->
                            ...
                            <p style="margin-top:5px">By signing up, you agree with our 
        ...
        <aside class="last">
            <div class="pdL3">
                ...
                <dl class="clear">
                    ...
                    <dd>Call at low rates by using local<span class="semi">access numbers</span></dd>
                </dl>
                ...
                <dl class="clear last">
                    ...
                    <dd>Get a lot more with <span class="semi">two-way calling</span> and other bundle of features.</dd>
                </dl>
