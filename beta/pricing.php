...
<meta name="description" content="Get best plans at lowest costs with quality routes when you call international from Phone91. Price always matters, but so does quality." /> 
...
<link rel="stylesheet" type="text/css" href="<?php echo $cssUrl?>pricing-style2.css" />
...
<script type="text/javascript" src="<?php echo $jsUrl?>rupee.js"></script>
<!--<script type="text/javascript" src="<?php //echo $jsUrl?>pricing.js"></script>-->
<script type="text/javascript" src="<?php echo $jsUrl?>pricingShow6.js"></script>
<!--<section id="common-banner" class="warmBg">
	<div class="wrapper clear">
    	<aside>
        	<figure class="ban-icon">
            	<img src="<?php echo $imgUrl?>sketch-pricing.png" alt="" title="" />
            </figure>
        </aside>
        <aside class="last">
...
<section id="search-container" class="warmBg">
	<div class="wrapper">
        <div class="clear searchOffer">
        		<div class="h3g ligt">It costs a <span>little</span> to call</div>
               ...
               <!--<span class="cmnsprt-80 people"></span>-->
                People <span>love</span> to call at</div>
                </div>
        </div>
    </div><!--/end of wrapper-->
 ...
 <section id="st-container" class="showhideDiv">
	<div class="wrapper clear">
            ...
            <aside>
                ...
                <div class="bgtxt">
                    0.0146 <sup class="WebRupee">$</sup><span class="">/min</span>
                </div>
            </aside>
            <aside>
            	<div class="clear">
                ...
                <div class="bgtxt">
                    0.1534 <sup>$</sup><span class="">/min</span>
                </div>
            </aside>
            <aside>
            	<div class="clear">
                ...
                <div class="bgtxt">
                    0.0150 <sup class="WebRupee">$</sup><span class="">/min</span>
                </div>
            </aside>
            <aside>
            	<div class="clear">
                ...
                <div class="bgtxt">
                    0.0085 <sup>$</sup><span class="">/min</span>
                </div>
            </aside>
    	...
    	<div class="offerHead">Offers for me</div>
            ...
            <!-- <div class="arrow_box"></div>-->
                    <div class="left">
                        ...
                        <p><a class="btn btn-fb" href="https://www.facebook.com/sharer/sharer.php?u=https://phone91.com" target="_blank">Share on Facebook</a>to stay updated with our weekly offers! </p>
                   </div>
                  <div class="right">
                  	<img alt="" title="" src="<?php echo $imgUrl?>offers.png" class="offerImg"/>
                  </div>
                        
             </div>
	  </div>
    
<div class="fs18 ligt alC">Payment accepted via</div>
<div class="payVia" style="/*remove this style*/background:url(images/pay-via.png); width:400px; height:42px; margin: 20px auto 50px; opacity: .7;"></div>

</div>
<!--//Offer Pop up widnow-->

<?php include_once('inc/footer.php') ?>
<script type='text/javascript' src='<?php echo $jsUrl?>jquery.simplemodal.js'></script> 
<script type='text/javascript' src='<?php echo $jsUrl?>basic.js'></script>
<script>
searchPrice();
