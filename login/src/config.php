...
global $apiConfig;
if($_SERVER['SERVER_NAME']=="phone91.com")
{
...
else if($_SERVER['SERVER_NAME']=="phone91.com")
{
    $oauth2_client_id='30203330065-8qcof05t2i4fjjr6fmp8fc93amm2d8pm.apps.googleusercontent.com';
    $oauth2_client_secret= 'E6vi_YlnmOx45AFQsUb-vhPL';
    $oauth2_redirect_uri='http://phone91.com/login/login-google.php';
}
...
$apiConfig = array(
    ...
    'oauth_consumer_key'    => 'phone91',
    'oauth_consumer_secret' => 'U_Y0gOJyykEZRKVlQ1lAu03Z',
