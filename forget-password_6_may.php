...
<form name="forgotPassword" class="forgotPassword" id="forgotPassword" method="post" action="https://voice.phone91.com/controller/forgotPasswordApi.php" onSubmit="return validate('userId' , 'forgotPassword');" > 
...
<div style="padding:40px 0 20px" class="wrapper clear">
    ...
    <form name="selectNumber" class="selectNumber" id="selectNumber" method="post" action="https://voice.phone91.com/controller/forgotPasswordApi.php" onSubmit="return validate('userId' , 'selectNumber');" >  
    <div class="clear step-wrap">
    	<aside class="boxsize">
        	<div class="pdR3">
...
<aside class="boxsize">
    ...
    <!--<form name="verifyNumber" class="verifyNumber" id="verifyNumber" onsubmit="sendDetail(this)" action="javascript:void(0)" > -->
        ...
        <div class="verifyform">
         ...
         <?php if($type == 'EMAIL'){ ?>
                ...
                <p class="para16 mdf">
                    ...
                    request another one via <a href="https://voice.phone91.com/controller/forgotPasswordApi.php?smsCall=MAIL&userId=<?php echo $confirmMobileNumber; ?>">Email</a>
                </p>
        ...
        <p class="para16 mdf">
            If you didn't receive the code yet, <br>
            request another one via <a href="https://voice.phone91.com/controller/forgotPasswordApi.php?smsCall=SMS&userId=<?php echo $number; ?>&countryCode=<?php echo $countryCode; ?>">SMS</a> or <a href="https://voice.phone91.com/controller/forgotPasswordApi.php?smsCall=CALL&userId=<?php echo $number; ?>&countryCode=<?php echo $countryCode; ?>">call</a>
        </p>
