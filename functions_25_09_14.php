...
//        $contactNumber = $request['countryCode'];
        $email = $request['id'];
        ...
        $connectUrl = "http://voice.phone91.com/api/checkVerifiedNumber";
        $params = array("number"=>$contactNumber,"type"=>2,'resellerId'=>2);
        #- Curl code -  
...
//        var_dump($resp);
    ...
    function verifyConfirmationApi($param)
    {
        ...
        $postParam = array('action'=>'verifyConfirmation','number'=>$param['number'],'code'=>$param['code'],'domain'=>'phone91.com');
        ...
        if(!$response || $response['status'] == 'error')
        {
             $response = json_encode(array( "msg" => "Invalid Confirmation Code" , "status" => "error" , "type" => 3 ));
